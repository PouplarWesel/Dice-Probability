...
def boxExp(diceAmount, boxXAmount, boxYAmount, trialNum):
    ...
    with open("experiment_results.txt", "w") as f:
        ...
        f.write(
            "{:>10s}\t{:>20s}\t{:>35s}\t{:>20s}\t{:>40s}\n".format(
                "",
                "Reactants (Successful Forward = 1)",
                "",
                "Products (Successful Reverse = 6)",
                "",
            )
        )
        f.write(
            "{:>10s}\t{:>20s}\t{:>35s}\t{:>20s}\t{:>40s}\n".format(
                "Throw",
                "Starting Dice",
                "Number of Successful Forward Reactions",
                "Starting Dice",
        ...
        for throw in range(1, trialNum + 1):
            backUp = "The amount of dice in each box is {} and {} respectively.".format(
                boxXCount, boxYCount
            )
            ...
            f.write(
                "{:>10d}\t{:>20d}\t{:>35d}\t{:>20d}\t{:>40d}\n".format(
                    throw, boxXCount, forwardCount, boxYCount, reverseCount
                )
            )
